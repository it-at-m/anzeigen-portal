...
export type SettingTOSettingNameEnum =
  (typeof SettingTOSettingNameEnum)[keyof typeof SettingTOSettingNameEnum];
...
export function SettingTOFromJSONTyped(
  json: any,
  ...
  return {
    ...
    fileValue:
      json["fileValue"] == null
        ? undefined
        : SwbFileTOFromJSON(json["fileValue"]),
  };
}
...
export function SettingTOToJSONTyped(
  value?: SettingTO | null,
