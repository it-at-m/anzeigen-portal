 ...
 */
export function instanceOfGetAds200Response(
  value: object
): value is GetAds200Response {
  return true;
}
...
export function GetAds200ResponseFromJSONTyped(
  json: any,
  ...
  return {
    content:
      json["content"] == null
        ? undefined
        : (json["content"] as Array<any>).map(AdTOFromJSON),
    totalElements:
    ...
    sort:
      json["sort"] == null
        ? undefined
        : GetAds200ResponseSortFromJSON(json["sort"]),
...
export function GetAds200ResponseToJSONTyped(
  value?: GetAds200Response | null,
  ...
  return {
    content:
      value["content"] == null
        ? undefined
        : (value["content"] as Array<any>).map(AdTOToJSON),
