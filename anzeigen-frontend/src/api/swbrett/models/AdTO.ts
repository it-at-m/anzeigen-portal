...
export type AdTOAdTypeEnum =
  (typeof AdTOAdTypeEnum)[keyof typeof AdTOAdTypeEnum];
...
export function AdTOFromJSONTyped(
  json: any,
  ...
  return {
    ...
    swbUser:
      json["swbUser"] == null ? undefined : SwbUserTOFromJSON(json["swbUser"]),
    adCategory:
      json["adCategory"] == null
        ? undefined
        : AdCategoryFromJSON(json["adCategory"]),
    ...
    creationDateTime:
      json["creationDateTime"] == null
        ? undefined
        : new Date(json["creationDateTime"]),
    expiryDate:
      json["expiryDate"] == null ? undefined : new Date(json["expiryDate"]),
    imagePreviewBase64:
      json["imagePreviewBase64"] == null
        ? undefined
        : json["imagePreviewBase64"],
    adImg:
      json["adImg"] == null ? undefined : SwbImageTOFromJSON(json["adImg"]),
    adFiles:
      json["adFiles"] == null
        ? undefined
        : (json["adFiles"] as Array<any>).map(SwbFileTOFromJSON),
...
export function AdTOToJSONTyped(
  value?: AdTO | null,
  ...
  return {
    ...
    link: value["link"],
    creationDateTime:
      value["creationDateTime"] == null
        ? undefined
        : value["creationDateTime"].toISOString(),
    expiryDate:
    ...
    adFiles:
      value["adFiles"] == null
        ? undefined
        : (value["adFiles"] as Array<any>).map(SwbFileTOToJSON),
    views: value["views"],
  };
}
