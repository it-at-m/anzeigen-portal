 ...
 */
export function instanceOfGetAds200ResponseSort(
  value: object
): value is GetAds200ResponseSort {
  return true;
}

export function GetAds200ResponseSortFromJSON(
  json: any
): GetAds200ResponseSort {
  return GetAds200ResponseSortFromJSONTyped(json, false);
}

export function GetAds200ResponseSortFromJSONTyped(
  json: any,
...
export function GetAds200ResponseSortToJSONTyped(
  value?: GetAds200ResponseSort | null,
