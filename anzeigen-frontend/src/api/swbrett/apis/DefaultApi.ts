...
export class DefaultApi extends runtime.BaseAPI {
     ...
     * GET ads
     */
    async getAdsRaw(requestParameters: GetAdsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AdTO>> {
     ...
     * GET ads
     */
    async getAds(requestParameters: GetAdsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<AdTO> {
