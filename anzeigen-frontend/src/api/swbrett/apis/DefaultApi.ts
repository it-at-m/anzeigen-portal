...
export class DefaultApi extends runtime.BaseAPI {
   ...
   */
  async createAdRaw(
    requestParameters: CreateAdRequest,
   ...
   * POST categories
   */
  async createAdCategoryRaw(
    requestParameters: CreateAdCategoryRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<AdCategory>> {
   ...
   * POST categories
   */
  async createAdCategory(
    requestParameters: CreateAdCategoryRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<AdCategory> {
    const response = await this.createAdCategoryRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
   ...
   * POST swbreads
   */
  async createSwbreadRaw(
    requestParameters: CreateSwbreadRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<AdTO>> {
    if (requestParameters["adTO"] == null) {
      throw new runtime.RequiredError(
  ...
  async createSwbread(
    ...
    const response = await this.createSwbreadRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
  ...
  async createUserRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<SwbUserTO>> {
   ...
   */
  async deactivateAdRaw(
    requestParameters: DeactivateAdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
    ...
    const response = await this.request(
      {
        path: `/ads/deactivate/{id}`.replace(
          `{${"id"}}`,
   ...
   */
  async deactivateSwbreadRaw(
    requestParameters: DeactivateSwbreadRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters["id"] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/swbreads/deactivate/{id}`.replace(
          `{${"id"}}`,
          encodeURIComponent(String(requestParameters["id"]))
        ),
        method: "PUT",
   ...
   */
  async deleteAdRaw(
    requestParameters: DeleteAdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters["id"] == null) {
      throw new runtime.RequiredError(
   ...
   */
  async deleteAdCategoryRaw(
    requestParameters: DeleteAdCategoryRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters["id"] == null) {
      throw new runtime.RequiredError(
   ...
   * DELETE swbreads/{id}
   */
  async deleteSwbreadRaw(
    requestParameters: DeleteSwbreadRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters["id"] == null) {
      throw new runtime.RequiredError(
   ...
   */
  async getAdRaw(
    requestParameters: GetAdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<AdTO>> {
    if (requestParameters["id"] == null) {
      throw new runtime.RequiredError(
   ...
   * GET categories/{id}
   */
  async getAdCategoryRaw(
    requestParameters: GetAdCategoryRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<AdCategory>> {
    if (requestParameters["id"] == null) {
      throw new runtime.RequiredError(
  ...
  async getAdCategory(
    ...
    const response = await this.getAdCategoryRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
   ...
   * GET categories
   */
  async getAllAdCategoriesRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Array<AdCategory>>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      jsonValue.map(AdCategoryFromJSON)
    );
  }
   ...
   * GET categories
   */
  async getAllAdCategories(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<Array<AdCategory>> {
  ...
  async getFileRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<SwbFileTO>> {
    if (requestParameters["id"] == null) {
      throw new runtime.RequiredError(
        "id",
  ...
  async getImageRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<SwbImageTO>> {
    if (requestParameters["id"] == null) {
      throw new runtime.RequiredError(
        "id",
   ...
   */
  async getSettingRaw(
    requestParameters: GetSettingRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<SettingTO>> {
    ...
    const response = await this.request(
      {
        path: `/settings/{settingName}`.replace(
          `{${"settingName"}}`,
          encodeURIComponent(String(requestParameters["settingName"]))
        ),
        method: "GET",
        headers: headerParameters,
        query: queryParameters,
  ...
  async getSettingsRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Array<SettingTO>>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      jsonValue.map(SettingTOFromJSON)
    );
  }
   ...
   */
  async getSwbreadRaw(
    requestParameters: GetSwbreadRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<AdTO>> {
    if (requestParameters["id"] == null) {
      throw new runtime.RequiredError(
   ...
   * GET swbreads
   */
  async getSwbreadsRaw(
    requestParameters: GetSwbreadsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<AdTO>> {
    if (requestParameters["isActive"] == null) {
      throw new runtime.RequiredError(
  ...
  async getSwbreads(
    ...
    const response = await this.getSwbreadsRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
  ...
  async getUserRaw(
    ...
    const response = await this.request(
      {
        path: `/users/admin/{userId}`.replace(
          `{${"userId"}}`,
   ...
   */
  async incrementAdViewRaw(
    requestParameters: IncrementAdViewRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters["id"] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/swbreads/incrementView/{id}`.replace(
          `{${"id"}}`,
          encodeURIComponent(String(requestParameters["id"]))
        ),
        method: "PUT",
   ...
   */
  async incrementViewRaw(
    requestParameters: IncrementViewRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters["id"] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/ads/incrementView/{id}`.replace(
          `{${"id"}}`,
          encodeURIComponent(String(requestParameters["id"]))
        ),
        method: "PUT",
   ...
   */
  async sanitizeImageRaw(
    requestParameters: SanitizeImageRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ...
  async sanitizeImage(
    ...
    const response = await this.sanitizeImageRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
   ...
   */
  async updateAdRaw(
    requestParameters: UpdateAdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<AdTO>> {
    if (requestParameters["id"] == null) {
      throw new runtime.RequiredError(
   ...
   * PUT categories/{id}
   */
  async updateAdCategoryRaw(
    requestParameters: UpdateAdCategoryRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<AdCategory>> {
    if (requestParameters["id"] == null) {
      throw new runtime.RequiredError(
   ...
   * PUT categories/{id}
   */
  async updateAdCategory(
    requestParameters: UpdateAdCategoryRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<AdCategory> {
    const response = await this.updateAdCategoryRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
   ...
   * PUT swbreads/{id}
   */
  async updateSwbreadRaw(
    requestParameters: UpdateSwbreadRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<AdTO>> {
    if (requestParameters["id"] == null) {
      throw new runtime.RequiredError(
  ...
  async updateSwbread(
    ...
    const response = await this.updateSwbreadRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
...
export type GetAdsTypeEnum =
  (typeof GetAdsTypeEnum)[keyof typeof GetAdsTypeEnum];
/**
 * @export
 */
...
export type GetSettingSettingNameEnum =
  (typeof GetSettingSettingNameEnum)[keyof typeof GetSettingSettingNameEnum];
/**
 * @export
 */
...
export type GetSwbreadsTypeEnum =
  (typeof GetSwbreadsTypeEnum)[keyof typeof GetSwbreadsTypeEnum];
